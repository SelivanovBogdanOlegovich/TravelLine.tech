...
const offices_route_1 = __importDefault(require("./routes/offices.route"));
const platformTimeline_route_1 = __importDefault(require("./routes/platformTimeline.route"));
...
app.use("/api/platform-timeline", platformTimeline_route_1.default);
app.use("/api/clients", clients_route_1.default);
app.use("/api/gallery", gallery_route_1.default);
app.use("/api/offices", offices_route_1.default);
